...
class EsttServiceEdgeCaseTest :
    DescribeSpec({
        ...
        describe("calculate with edge cases") {
            ...
            it("should return no estimate when seasonal flying time is zero and history is insufficient") {
                val seasonalFlight = SeasonalFlight(
                    "MU9941",
                    "1234567",
                    0L,
                ...
                response.source shouldBe com.gzzn.airport.model.EstimateSource.NONE
            }
        }
